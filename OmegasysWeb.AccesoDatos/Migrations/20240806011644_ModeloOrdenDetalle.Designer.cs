...
namespace OmegasysWeb.AccesoDatos.Migrations
{
    ...
    [Migration("20240806011644_ModeloOrdenDetalle")]
    partial class ModeloOrdenDetalle
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OmegasysWeb.Modelos.Bodega", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OmegasysWeb.Modelos.CarroCompra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OmegasysWeb.Modelos.Compania", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OmegasysWeb.Modelos.Orden", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OmegasysWeb.Modelos.OrdenDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OmegasysWeb.Modelos.UsuarioAplicacion", b =>
                {
            ...
            modelBuilder.Entity("OmegasysWeb.Modelos.Compania", b =>
                {
                    b.HasOne("OmegasysWeb.Modelos.UsuarioAplicacion", "ActualizadoPor")
                        .WithMany()
                    ...
                    b.HasOne("OmegasysWeb.Modelos.UsuarioAplicacion", "CreadoPor")
                        .WithMany()
            ...
            modelBuilder.Entity("OmegasysWeb.Modelos.OrdenDetalle", b =>
                {
                    b.HasOne("OmegasysWeb.Modelos.Orden", "Orden")
                        .WithMany()
            ...
            modelBuilder.Entity("OmegasysWeb.Modelos.Producto", b =>
                {
                    b.HasOne("OmegasysWeb.Modelos.Categoria", "Categoria")
                        .WithMany()
                        .HasForeignKey("CategoriaId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("OmegasysWeb.Modelos.Marca", "Marca")
                        .WithMany()
                        .HasForeignKey("MarcaId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("OmegasysWeb.Modelos.Producto", "Padre")
                        .WithMany()
